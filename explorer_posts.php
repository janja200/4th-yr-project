    ...
    if(isset($_GET['offset']) && isset($_GET['limit'])){  
      ...
      include("functions/functions.php");
         if(!isset($_COOKIE['SNID'])){
          ...
          $limit=$_GET['limit'];
          $offset=$_GET['offset'];
          $user="SELECT posts.post_id,users.user_id,posts.post_likes,posts.post_content,posts.upload_image,
          ...
          user_region LIKE '%$search%') ORDER BY posts.post_likes DESC,posts.post_date DESC LIMIT $limit OFFSET $offset";
        ...
        echo"please enter a place u would like to visit";
      }
      }
?>
