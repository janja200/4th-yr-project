...
$get_posts="SELECT posts.post_id,users.user_id,posts.post_content,posts.upload_image,
...
location.user_id=users.user_id AND user_from=$userid AND (post_content LIKE '%$search_query%' OR  f_name like '%$search_query%'
OR l_name like '%$search_query%' OR user_name like '%$search_query%') ORDER BY location.dist_diff ASC,posts.post_likes DESC,posts.post_date DESC LIMIT $limit OFFSET $offset";
